...
* https://developers.redhat.com/products/codeready-workspaces/overview[Red Hat OpenShift Dev Spaces,window=_blank] - Eclipse Che ベースの Visual Studio ライクな Web ブラウザ経由で利用できる IDE 環境です。本ワークショップの開発環境です。
...
右下にあるボタンをクリックして次のトピックへ進むことができます。また、左側のメニューを使用して、他のセクションへ自由に移動することもできます。
